  ...
  return (
    <Section id="learn">
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_0.85fr]">
        <GlassCard variant="glass" spotlight={true} className={`${styles.card} overflow-hidden p-0`}>
          <div className="divide-y divide-border/60">
            {articles.map((article) => (
              <Link className="group flex items-center justify-between gap-6 p-6 transition hover:bg-white/5" href="/articles" key={article.title}>
                <span>
        ...
        <GlassCard variant="glass" spotlight={true} className={`${styles.card} p-7`}>
